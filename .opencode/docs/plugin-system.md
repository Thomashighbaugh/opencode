...
**Long session threshold** — artifact saved only when any of: >75 tool calls, >15 min duration, or >5 subagent invocations. See [State Management](./state-management.md#compaction-artifacts) for full details.
