...
- **feat(hubs): model tiering fallback — ollama → opencode-go provider switching**
  ...
  - Updated `.opencode/context/docs/model-configuration.md`: added Model Tiering & Fallback section with config reference and protocol table
