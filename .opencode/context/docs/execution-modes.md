---
title: "Execution Modes Reference"
type: entity
tags: [docs, execution-modes, orchestration]
created: 2026-05-01
updated: 2026-07-29
status: active
---
...
- [Skills](../docs/skills.md) - Workflow skills including mode skills
- [Agents](../docs/agents.md) - Available agents for task execution
- [Tools](../docs/tools.md) - TypeScript tools for state management
- [Plugin System](../docs/plugin-system.md) - Hook system implementation