---
title: "New Agent Creation System"
type: entity
tags: [docs, agents, creation]
created: 2026-05-01
updated: 2026-07-29
status: active
---
...
**Finding**: OpenCode uses this in production
...
.opencode/context/project/{agent-name}-context.md
  └─ Project context (AGENTS.md pattern)
...
- **OpenCode Production Patterns**
  - AGENTS.md pattern for project context
