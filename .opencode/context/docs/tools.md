...
- [Execution Modes](../docs/execution-modes.md) - Modes that use these tools
- [Skills](../docs/skills.md) - Skills that invoke tools
- [Plugin System](../docs/plugin-system.md) - How tools hook into the system