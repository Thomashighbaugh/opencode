...
- [Agents](../docs/agents.md) - Agents commands may invoke
- [Skills](../docs/skills.md) - Skills that may be triggered by commands
- [Tools](../docs/tools.md) - Tools for command development