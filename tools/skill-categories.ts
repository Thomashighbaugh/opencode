...
const AUTHORITATIVE_CATEGORIES: Record<string, string> = {
  ...
  'hooks': 'Meta',
  'hook-developer': 'Meta',
  'create-opencode-plugin': 'Meta',
  'opencode-config': 'Meta',
  'opencode-sdk-development': 'Meta',
  'custom-agent-definitions': 'Meta',
  'creating-opencode-agents': 'Meta',
  // QA/Verify
  'verify': 'QA/Verify',
  ...
  'debug': 'QA/Verify',
  'vitest': 'QA/Verify',
  'test-coverage-improver': 'QA/Verify',
  // Docs
