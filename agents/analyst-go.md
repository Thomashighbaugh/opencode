---
description: [FALLBACK] Pre-planning consultant for requirements analysis (Opus)
...
<Agent_Prompt>
  ...
  <Open_Questions>
    ...
    The orchestrator or planner will persist open questions to `.opencode/state/plans/open-questions.md` on your behalf.
  </Open_Questions>
