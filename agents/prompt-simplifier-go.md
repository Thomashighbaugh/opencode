---
description: [FALLBACK] Analyzes prompts and instructions for logical complexity. Decomposes into graphs, identifies unnecessary paths, edge cases, and outputs simplification recommendations.
