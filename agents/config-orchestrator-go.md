---
description: [FALLBACK] Orchestrate OpenCode configurations. Use when setting up, modifying, or validating opencode.json(c), skills, agents, commands, tools, plugins, or AGENTS.md files.
