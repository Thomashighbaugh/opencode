...
---
> **Reference tables** (command-specific flags, banned commands, prompt handling, CI patterns) are in the merged reference section below. Load this file when you need lookup tables for specific commands.
