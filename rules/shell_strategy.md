...
To match the high-agency, autonomous capabilities of advanced models (like glm-5.1), this strategy enforces strict cognitive patterns. These are not just shell tips; they are **behavioral requirements** for success in this environment.
