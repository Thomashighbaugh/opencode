...
2. **Implement Single Fix** — Address the root cause, ONE change at a time, no bundled refactoring
3. **Verify Fix** — Test passes? No other tests broken? Issue actually resolved?
4. **If Fix Doesn't Work** — < 3: Return to Phase 1. ≥ 3: **STOP and question the architecture**
5. **If 3+ Fixes Failed: Question Architecture** — Is this pattern fundamentally sound? Should we refactor architecture vs. continue fixing symptoms?
