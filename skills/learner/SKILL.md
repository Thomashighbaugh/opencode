...
- **User-level**: ${OPENCODE_CONFIG_DIR:-~/.config/opencode}/skills/omc-learned/ - Rare. Only for truly portable insights.
- **Project-level**: .opencode/state/skills/ - Default. Version-controlled with repo.
