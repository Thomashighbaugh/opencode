---
name: trace
description: Evidence-driven tracing lane that orchestrates competing tracer hypotheses in OpenCode built-in team mode
...
Use **OpenCode built-in team mode** for `/trace`.
...
3. "Create one tracer lane per hypothesis using OpenCode built-in team mode."
