...
3. **Verify prerequisites** — `which opencode`, skill installed
...
- If `opencode` is not found, the script exits with a clear error message.
- If the autoresearch skill is not installed, OpenCode will report an unknown command.
